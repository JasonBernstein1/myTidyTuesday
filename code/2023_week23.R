...
countries <- tibble(
  country = c('Algeria', 'Angola', 'Congo', 'Equatorial Guinea',
...
df |>
  ...
  facet_wrap(~ facet_lab, nrow = 4, scales = 'free_y',
             strip.position = 'bottom') +
  theme_void() +
  labs(
    title = glue::glue('Oil Production for Countries in ',
  ...
  theme(
    ...
    plot.title = element_markdown(size = 26, hjust = 0,
...
ggsave(filename = './images/2023_week23.png',
       height = 10, width = 14)
